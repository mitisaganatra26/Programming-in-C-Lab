...
int main() {
	...
	double discriminant;   //value of b^2 -4ac
	double root1, root2;   //Real roots(if discriminant is >=0)
	double realPart, imagPart;   //For string real and imaginary parts if the roots are complex
